...
| `company.certificates.items.0` | 400x560 | - | 인증서 썸네일 1 | - |
| `company.certificates.items.1` | 400x560 | - | 인증서 썸네일 2 | - |
| `company.certificates.items.2` | 400x560 | - | 인증서 썸네일 3 | - |
...
| `company.location.tabs.0.photo` | 800x450 | - | 찾아오시는 길 탭1 사진 (선택) | - |
| `company.location.tabs.1.photo` | 800x450 | - | 찾아오시는 길 탭2 사진 (선택) | - |
| `company.location.tabs.2.photo` | 800x450 | - | 찾아오시는 길 탭3 사진 (선택) | - |
| `company.location.tabs.3.photo` | 800x450 | - | 찾아오시는 길 탭4 사진 (선택) | - |
| `company.location.tabs.4.photo` | 800x450 | - | 찾아오시는 길 탭5 사진 (선택) | - |
...
| `management.esg.pillars.0` | 360x240 | - | ESG 3축 카드 1 | - |
| `management.esg.pillars.1` | 360x240 | - | ESG 3축 카드 2 | - |
| `management.esg.pillars.2` | 360x240 | - | ESG 3축 카드 3 | - |
| `management.ethics.banner` | 1200x400 | - | 윤리경영 상단 | - |
| `management.ethics.icons.0` | 120x120 | - | 윤리 4원칙 아이콘 1 | - |
| `management.ethics.icons.1` | 120x120 | - | 윤리 4원칙 아이콘 2 | - |
| `management.ethics.icons.2` | 120x120 | - | 윤리 4원칙 아이콘 3 | - |
| `management.ethics.icons.3` | 120x120 | - | 윤리 4원칙 아이콘 4 | - |
...
| `prCenter.news.hero` | 1920x420 | - | 뉴스 목록 IntroHero | - |
...
| `technology.tech1.process.0` | 280x200 | - | tech-1 프로세스 아이콘 1 (선택) | - |
| `technology.tech1.process.1` | 280x200 | - | tech-1 프로세스 아이콘 2 (선택) | - |
| `technology.tech1.process.2` | 280x200 | - | tech-1 프로세스 아이콘 3 (선택) | - |
| `technology.tech1.process.3` | 280x200 | - | tech-1 프로세스 아이콘 4 (선택) | - |
