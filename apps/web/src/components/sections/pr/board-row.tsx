 ...
 * ==============================
 * PC table row / MO list item — 번호·카테고리·제목·날짜
 *
 * [Main Functions]
 * - BoardTableRow
 * - BoardListRow
...
// 2. BoardListRow
export function BoardListRow({ article, href, categoryLabel, pinnedLabel }: BoardRowProps) {
  return (
    <li className="border-b border-neutral-200 py-4">
